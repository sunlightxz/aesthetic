...
const About = () => {
  ...
  useEffect(() => {
    ...
    .fromTo(
        ...
        { scale: 1, ease: "power2.inOut" ,duration : 1.2},
      0
      )
    ...
    const newHorizontalTl = gsap.timeline({
      scrollTrigger: {
        ...
        scrub: true,
        onUpdate: (self) => {
          const progress = self.progress.toFixed(2) * 120;
  ...
  return (
    <div className="relative">
      ...
      <div ref={scrollContainer} className="w-[400vw] flex relative overflow-hidden">
        ...
        <div className="flex flex-col h-[200vh] bigred">
          <div className="h-screen w-screen">
              <div className="grid h-full">
                <div className="grid-cols-2 h-screen flex items-stretch justify-stretch bg-white">
